...
func NewEventStorage(db *gorm.DB) *UserStorage {
...
func (s EventStorage) GetAll() (map[int64]*model.User, error) {
...
// GetOne user
func (s EventStorage) GetOne(id string) (model.User, error) {
...
func (s EventStorage) getOneWithAssociations(id int64) (model.User, error) {
	var user model.User
	s.db.First(&user, id)
...
// Insert a user
func (s *EventStorage) Insert(c model.User) (string, error) {
...
// Update a user
func (s *EventStorage) Update(c model.User) error {
...
func (s *EventStorage) updateChocolatesByChocolatesIDs(u *model.User) error {
